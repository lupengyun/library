...
import com.yun.yunlibrary.R;
import com.yun.yunlibrary.selectpic.widget.ViewPagerFixed;
...
public class PhotoPreviewActivity extends AppCompatActivity implements PhotoPagerAdapter.PhotoViewClickListener {
    ...
    public static void launch(Context context, String path) {
        ...
        intent.putStringArrayListExtra(EXTRA_PHOTOS, photoPath);
        context.startActivity(intent);
    }

    public static void launch(Context context, List<String> path) {
        Intent intent = new Intent(context, PhotoPreviewActivity.class);
        intent.putStringArrayListExtra(EXTRA_PHOTOS, new ArrayList<String>(path));
        context.startActivity(intent);
    }
